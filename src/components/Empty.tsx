    ...
    <div className={'h-full w-full bg-zinc-800 flex items-center justify-center'}>
      <div className={'flex flex-col items-center space-y-3 -translate-y-20'}>
        ...
        <div className={'pl-4 space-y-3'}>
          <div
            className={'px-3 flex items-center duration-200 text-blue-400 cursor-pointer hover:text-blue-600 w-72'}
            onClick={action((e) => {
          ...
          <div
            className={'px-3 duration-200 text-blue-400 cursor-pointer hover:text-blue-600 w-72'}
            onClick={(e) => {
              e.stopPropagation()
