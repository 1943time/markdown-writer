...
const addActions = (editor: TextEditor) => {
  addKeybinding(editor, 'toggleBold', toggleBold, [KeyMod.CtrlCmd | KeyCode.KeyB], configStore.getI18nText('editorCtxMenuItems.toggleBold'))
  addKeybinding(editor, 'toggleItalic', toggleItalic, [KeyMod.CtrlCmd | KeyCode.KeyI], configStore.getI18nText('editorCtxMenuItems.toggleItalic'))
  addKeybinding(editor, 'toggleCodeSpan', toggleCodeSpan, [KeyMod.Alt | KeyCode.Backquote], configStore.getI18nText('editorCtxMenuItems.toggleCodeSpan'))
  addKeybinding(editor, 'toggleStrikethrough', toggleStrikethrough, [KeyMod.Alt | KeyCode.KeyS], configStore.getI18nText('editorCtxMenuItems.toggleStrikethrough'))
  ...
  addKeybinding(editor, 'toggleHeadingUp', toggleHeadingUp, [KeyMod.WinCtrl | KeyMod.Shift | KeyCode.BracketRight], configStore.getI18nText('editorCtxMenuItems.toggleHeadingUp'))
  addKeybinding(editor, 'toggleHeadingDown', toggleHeadingDown, [KeyMod.WinCtrl | KeyMod.Shift | KeyCode.BracketLeft], configStore.getI18nText('editorCtxMenuItems.toggleHeadingDown'))
  addKeybinding(editor, 'toggleList', toggleList, [KeyMod.CtrlCmd | KeyCode.KeyL], configStore.getI18nText('editorCtxMenuItems.toggleList'))
}
